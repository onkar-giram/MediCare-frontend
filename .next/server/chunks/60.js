...
/* harmony export */   "Z": () => (/* binding */ ConnectButton)
/* harmony export */ });
...
/* harmony import */ var _modulz_radix_icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(294);
/* harmony import */ var _modulz_radix_icons__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modulz_radix_icons__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_Utils_Icons_MetamaskIcon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2147);
...
const IconDisconnect = ()=>{
    return /*#__PURE__*/ _jsx(ActionIcon, {
        color: "blue",
        size: "xs",
        children: /*#__PURE__*/ _jsx(IconPlugConnectedX, {})
    });
};
function ConnectButton() {
    ...
    const { isConnected , isDisconnected , address  } = (0,wagmi__WEBPACK_IMPORTED_MODULE_2__.useAccount)();
    const [isDefinitelyConnected, setIsDefinitelyConnected] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        window && window.localStorage.getItem("connected") && connect({
    ...
    return isDefinitelyConnected ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mantine_core__WEBPACK_IMPORTED_MODULE_3__.Box, {
        onClick: disconnect,
        w: "100%",
        h: "100%",
        sx: {
...
/* harmony export */ });
/* unused harmony export LogosMetamaskIcon */
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
...
function LogosMetamaskIcon(props) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LogosMetamaskIcon);
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": () => (/* binding */ useValidTxnData)
/* harmony export */ });
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([wagmi__WEBPACK_IMPORTED_MODULE_0__, swr__WEBPACK_IMPORTED_MODULE_1__]);
([wagmi__WEBPACK_IMPORTED_MODULE_0__, swr__WEBPACK_IMPORTED_MODULE_1__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);


const fetcher = (url)=>fetch(url).then((res)=>res.json());
// This hook returns all the variables required for executing a
// smart contract function
function useValidTxnData() {
    const { data: contract  } = (0,swr__WEBPACK_IMPORTED_MODULE_1__["default"])("/api/constants", fetcher);
